...
exports.login = catchAsync(async (req, res, next) => {
  ...
  // 3. if everything's ok, send token to the client
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  // 2. If th token has not expired, and there is user, set the new password
  if (!user)
  ...
  // 3. Update the chengePasswordAt property for the user
